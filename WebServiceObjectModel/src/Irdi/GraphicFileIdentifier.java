...
public class GraphicFileIdentifier extends IRDI implements java.io.Serializable 
{

	/**
	 * 
	 */
	private static final long serialVersionUID = -8363591801747115490L;
	private String graphicFileIdentifier;
	
	
    /*Axis needs default constructor*/
	public GraphicFileIdentifier()
	{
	...
	{
		this.graphicFileIdentifier = irdi;
	...
	{
		this.graphicFileIdentifier = value;
	}
	
	@Override
	public String getGraphicFileIdentifierValue()
	{
		return this.graphicFileIdentifier;
	}
