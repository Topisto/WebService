...
public class ReferencingDocumentIdentifier extends IRDI implements java.io.Serializable 
{

	/**
	 * 
	 */
	private static final long serialVersionUID = -7747874326365169898L;
	private String referencingDocumentIdentifier;
	
	
    /*Axis needs default constructor*/
	public ReferencingDocumentIdentifier()
	{
	...
	{
		this.referencingDocumentIdentifier = irdi;
	...
	{
		return this.referencingDocumentIdentifier;
	}

	@Override
	public void setReferencingDocumentIdentifierValue(String value)
	{
		this.referencingDocumentIdentifier = value;
	}
