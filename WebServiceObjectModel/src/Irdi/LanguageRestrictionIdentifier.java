...
public class LanguageRestrictionIdentifier extends IRDI implements java.io.Serializable 
{

	/**
	 * 
	 */
	private static final long serialVersionUID = -6771350326503463720L;
	private String languageRestrictionIdentifier;
	
	
    /*Axis needs default constructor*/
	public LanguageRestrictionIdentifier()
	{
	...
	{
		this.languageRestrictionIdentifier = irdi;
	...
	{
		this.languageRestrictionIdentifier = value;
	}
	
	@Override
	public String getLanguageRestrictionIdentifierValue()
	{
		return this.languageRestrictionIdentifier;
	}
