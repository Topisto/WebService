...
public class AbbreviationIdentifier extends IRDI implements java.io.Serializable 
{

	/**
	 * 
	 */
	private static final long serialVersionUID = 3479139184285599826L;
	private String abbreviationIdentifier;
	...
	{
	  this.abbreviationIdentifier = irdi;
	...
	{
		return this.abbreviationIdentifier;
	}
	
	@Override
	public void setAbbreviationIdentifierValue(String value)
	{
		this.abbreviationIdentifier = value;
	}
