...
public class FileRepresentationIdentifier extends IRDI implements java.io.Serializable 
{

	/**
	 * 
	 */
	private static final long serialVersionUID = 8009286674457459921L;
	private String fileRepresentationIdentifier;
	
	
    /*Axis needs default constructor*/
	public FileRepresentationIdentifier()
	{
	...
	{
		this.fileRepresentationIdentifier = irdi;
	...
	{
		return this.fileRepresentationIdentifier;
	}
	...
	{
		this.fileRepresentationIdentifier = value;
	}
