...
public class ContainingDocumentIdentifier extends IRDI implements java.io.Serializable 
{

	/**
	 * 
	 */
	private static final long serialVersionUID = 1932725937370993267L;
	private String containingDocumentIdentifier;
	
	
    /*Axis needs default constructor*/
	public ContainingDocumentIdentifier()
	{
	...
	{
		this.containingDocumentIdentifier = irdi;
	...
	{
		return this.containingDocumentIdentifier;
	}
	...
	{
		this.containingDocumentIdentifier = value;
	}
